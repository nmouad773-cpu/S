...
const LIVE_ACCESS_TOKEN = "EAAZAfLN8JuaMBSMMjwBTrfeTvrZAJpUGmMzhmi3JgQkWcxCeCj6c5LjuIq3RSh5EyJ4qjxslDohvEmeO7OdjfyQ4SelCZB6fZA5OrZBjAhZCPEVq7rS5VeyZAzrqe9V1XlX5sj6suETxTlsg3c49pgwosQEZCZCBcufbXvFLwJenAgrdSX9yD69vmviVMAjzZCuXHDFw4oThTc";
const LIVE_PAGE_ID      = "466039649924341"; 

// --- بيانات الوصول لتعديل المنشور ---
const POST_ACCESS_TOKEN = "EAAZAfLN8JuaMBSL5w3hfg9ZBfxHf3bQ8rZAqbweZAImsmJTiXGyyHseGhRG8fc9wORVES51HTCIrSpWWZBDOr0yzRVsH1MMvzNPyb73AvKsrUVyZCJqk950k5qt1PFf6AcFysXIhhLBJqzQj7Onfpnc6vcCtR5GicCqXRPFrZBoEZA5xzNynVnz71i2zLKSg805aGskCRtwQ";
const POST_PAGE_ID      = "1288067541053277";
const POST_ID           = "122100265965401514";

// --- قائمة القنوات الشاملة (21 قناة) ---
const CHANNELS = [
    { 
        name: "beIN News", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/986992.ts", 
    ...
    { 
        name: "beIN 1",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/986994.ts",  
    ...
    { 
        name: "beIN 2",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/986995.ts",  
    ...
    { 
        name: "beIN 3",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/986996.ts",  
    ...
    { 
        name: "beIN 4",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/986997.ts",  
    ...
    { 
        name: "beIN 5",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/986998.ts",  
    ...
    { 
        name: "beIN 6",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/986999.ts",  
    ...
    { 
        name: "beIN 7",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/987000.ts",  
    ...
    { 
        name: "beIN 8",    
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/987001.ts",  
    ...
    { 
        name: "الثمانية 1", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/1279492.ts", 
    ...
    { 
        name: "الثمانية 2", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/1279491.ts", 
        img: "https://scontent.xx.fbcdn.net/v/t39.30808-6/752648857_122100395247401514_7968696883797853697_n.jpg?stp=dst-jpg_tt6&cstp=mx240x240&ctp=s240x240&_nc_cat=109&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=833d8c&_nc_ohc=2FRLcPqDq_cQ7kNvwEXeapC&_nc_oc=AdpXohEoQ7ZJmb3FvdIif-lHhpFlq8DqVZpSfLUom1XR48oQuFzdVebk1QiK1HZEAzU&_nc_zt=23&_nc_ht=scontent.fcmn5-1.fna&_nc_gid=-kptSb0bXqpmqziwEiUyqg&_nc_ss=7b289&oh=00_AQBQFybFXkZv6AM5d3oYYfbgH_4dQ7pbGTALBAzsfbDsTQ&oe=6A645902" 
    },
    { 
        name: "الثمانية 3", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/1286660.ts", 
        img: "https://scontent.xx.fbcdn.net/v/t39.30808-6/752648857_122100395247401514_7968696883797853697_n.jpg?stp=dst-jpg_tt6&cstp=mx240x240&ctp=s240x240&_nc_cat=109&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=833d8c&_nc_ohc=2FRLcPqDq_cQ7kNvwEXeapC&_nc_oc=AdpXohEoQ7ZJmb3FvdIif-lHhpFlq8DqVZpSfLUom1XR48oQuFzdVebk1QiK1HZEAzU&_nc_zt=23&_nc_ht=scontent.fcmn5-1.fna&_nc_gid=-kptSb0bXqpmqziwEiUyqg&_nc_ss=7b289&oh=00_AQBQFybFXkZv6AM5d3oYYfbgH_4dQ7pbGTALBAzsfbDsTQ&oe=6A645902" 
    },
    { 
        name: "Mbc 2", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/978.ts", 
    ...
    { 
        name: "Mbc 3", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/977.ts", 
        img: "https://scontent.xx.fbcdn.net/v/t39.30808-6/753298323_122100453267401514_3476795863090484615_n.jpg?stp=dst-jpg_tt6&cstp=mx160x160&ctp=s160x160&_nc_cat=106&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=833d8c&_nc_ohc=F1svTvMdrB4Q7kNvwGP4jbp&_nc_oc=AdpHDDaJTaUqr9jmf0PdDJvwhL1l2JEY9yVyIJA99B15pnRxvC3X1VBJKlqQxWLG5p4&_nc_zt=23&_nc_ht=scontent.fcmn5-2.fna&_nc_gid=WnkG4EqtfRDBCwMRQYRwnQ&_nc_ss=79289&oh=00_AQAsB12Q3hbcPYVmmySxZA5pC_W4ZlR6bRbm9I-S_988ww&oe=6A6485DD" 
    },
    { 
        name: "Mbc 4", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/1088898.ts", 
        img: "https://scontent.xx.fbcdn.net/v/t39.30808-6/754007087_122100453411401514_5987379144688097958_n.jpg?stp=dst-jpg_tt6&cstp=mx1284x1284&ctp=s1284x1284&_nc_cat=109&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=833d8c&_nc_ohc=rMZr_L9OeCEQ7kNvwG4UtGS&_nc_oc=Adr2hB9EPItNKSQal7Bw9A9W3q_wDn0FaOSziqULUqZ3Iajt_4mSYSYWY05s7K-Ztw8&_nc_zt=23&_nc_ht=scontent.fcmn7-1.fna&_nc_gid=WnkG4EqtfRDBCwMRQYRwnQ&_nc_ss=79289&oh=00_AQAeAJ5HIBAOzI_Xtyg2RRltRJ4UCCj7i-FUnfKtqatQpA&oe=6A6488A4" 
    },
    { 
        name: "Mbc 5", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/68061.ts", 
        img: "https://scontent.xx.fbcdn.net/v/t39.30808-6/751751765_122100453375401514_1500326668910306352_n.jpg?stp=dst-jpg_tt6&cstp=mx678x452&ctp=s678x452&_nc_cat=107&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=833d8c&_nc_ohc=5z9e2zaHIQwQ7kNvwGEf8ok&_nc_oc=AdohyAete4SR9PEc3Q8L2PLOY2QWxO3peGfnZRhyonRehKj_vkWk_0QwGx8k9mSGqXw&_nc_zt=23&_nc_ht=scontent.fcmn7-1.fna&_nc_gid=WnkG4EqtfRDBCwMRQYRwnQ&_nc_ss=79289&oh=00_AQB-cPsv-90voPGeZHUpoIJA6PRzuHP_lVvPOrX5JNPdgQ&oe=6A647717" 
    },
    { 
        name: "Al aoula HD", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/14795.ts", 
    ...
    { 
        name: "2m maroc", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/14792.ts", 
        img: "https://scontent.fcmn7-1.fna.fbcdn.net/v/t39.30808-6/751738154_122101029315401514_7668531375224878344_n.jpg?stp=dst-jpg_tt6&cstp=mx320x320&ctp=s320x320&_nc_cat=104&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=833d8c&_nc_ohc=_vlmDUu9PqwQ7kNvwEC1Luh&_nc_oc=Adol32V5RS-UOcahs3nUjpUMuc4FlDVasbtRYH5qkmS9IiuBG9xDu8a_K8NdOngqQm0&_nc_zt=23&_nc_ht=scontent.fcmn7-1.fna&_nc_gid=Nv-1ScKdj0qpQQdGjxDoWA&_nc_ss=7b289&oh=00_AQD3Us-mDaXbCGdHH0CthNLPS2y7AESPu-HBoIEJF57xeA&oe=6A65386D" 
    },
    { 
        name: "Arryadia HD", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/762869.ts", 
        img: "https://scontent.xx.fbcdn.net/v/t39.30808-6/752845929_122101029141401514_180650434062533038_n.jpg?stp=dst-jpg_tt6&cstp=mx225x225&ctp=s225x225&_nc_cat=107&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=833d8c&_nc_ohc=9LYr1DYQ9OEQ7kNvwHDRemh&_nc_oc=AdqlhG0UkcCg6yE9quFMsCyG2QZwv4cA1QZvAHu-Crd1IMOg3zT5A5C_SZaQHlMaDUw&_nc_zt=23&_nc_ht=scontent.fcmn5-2.fna&_nc_gid=Nv-1ScKdj0qpQQdGjxDoWA&_nc_ss=7b289&oh=00_AQBuzdKvU0rfp2KWdTZ3ACZH3rP4q8OPZjBZFx4lRQtf_A&oe=6A654C95" 
    },
    { 
        name: "National Geo", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/597571.ts", 
    ...
    { 
        name: "قران الكريم", 
        url: "http://akkaouiz.xyz/live/EWXP84N/Q2Y8Z8U/909136.ts", 
        img: "https://scontent.xx.fbcdn.net/v/t39.30808-6/481069067_28543685108611474_5115389696913786814_n.jpg?stp=dst-jpg_tt6&cstp=mx554x554&ctp=s554x554&_nc_cat=108&_nc_map=urlgen_bucketless&ccb=1-7&_nc_sid=cc71e4&_nc_ohc=R1OK0f6lNJoQ7kNvwHGZGMl&_nc_oc=Adq5Uh5xsY1Ohfr72pWsTqP08QgRoN8dCb-wYj6QCOfH4DBpgMxtw3ONnCnNHOgU-Gc&_nc_zt=23&_nc_ht=scontent.fcmn5-1.fna&_nc_gid=mOz-oEmz7G5mWHXyHbiy8Q&_nc_ss=7b289&oh=00_AQC-c1t_wjjUtmojlfC1GBjC6QIoF9Kyy_1jREEk6C37Sw&oe=6A677B5C" 
    }
];

// تعديل المدة الإجمالية لتناسب بيئة GitHub Actions (تحديد المهلة بـ 3 ساعات و 30 دقيقة للجلسة الواحدة)
const SESSION_MS  = (3 * 60 + 30) * 60 * 1000; 
...
async function runSession() {
    ...
    if (procs.length === 0) {
        console.log("  ⚠️ لم يتم إنشاء أي جلسات بث، إنهاء العملية...");
        return;
    }

    console.log(`\n3️⃣ انتظار استقرار البث لتوليد روابط DASH...`);  
    await countdown(MPD_WAIT_MS, "⏰ الانتظار");  

    console.log(`\n4️⃣ جلب روابط DASH (MPD) وتحديث المنشور...`);  
    ...
    if (remaining > 0) {  
        console.log(`\n🚀 البث يعمل بنجاح! الانتظار حتى اكتمال مدة الجلسة...`);  
        await countdown(remaining, "⏰ المتبقي على نهاية الجلسة");  
    }  

    console.log(`\n5️⃣ إغلاق الجلسة وتنظيف الموارد...`);  
    procs.forEach(p => { try { p.kill("SIGKILL"); } catch {} });  
    try { execSync("pkill -9 ffmpeg 2>/dev/null || true"); } catch {}
...
async function main() {
    console.log("==========================================");
    console.log("   Facebook Live Multi-Streamer (GitHub)  ");
    console.log("==========================================\n");
